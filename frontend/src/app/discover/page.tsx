...
export const revalidate = 0; // Prevent Next.js from aggressively caching this page so we see DB changes
...
export default async function DiscoverPage() {
  ...
  try {
    ...
    console.error("Failed to fetch discovery datasets:", error);
    fetchError = true;
  }
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col pb-24 pt-8">
        ...
        <section className="relative overflow-hidden rounded-3xl p-10 mx-4 sm:mx-6 lg:mx-8 mb-6 mt-4">
          ...
          <div className="relative z-10 text-white w-full">
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-3 drop-shadow-md">Discover</h1>
            <p className="text-lg md:text-xl font-medium opacity-90 max-w-2xl text-blue-50">
              Explore the freshest albums, chart-topping hits, and trending artists on Listenism this week.
            </p>
          </div>
        </section>
        ...
        {/* 5. Newest Artists (just uploaded songs) */}
